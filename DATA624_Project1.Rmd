...
* I am curious about the distrobution of cash considering the forecast ask for this project.
...
* ATM3 only has 3 dates with withdrawals 4-28 through 4-30 or 2010
* These results also brings to question whether there may be some seasonality that will impact May's forecasting
* Considering the distrobution, I chose to replace the missing values with the median, as the skewed values in ATM 3 & 4 I believe with negatively impact the mean
...
Below we again filter out data 
...
#forecast_ATM2 April
forecast_ATM2_1 <- atm2_fit %>%
  forecast(h = 30)

#forecast_ATM2 April
forecast_ATM2_2 <- atm2_fit2 %>%
  forecast(h = 30)
